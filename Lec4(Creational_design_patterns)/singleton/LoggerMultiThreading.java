...
public class LoggerMultiThreading {
    ...
    public static synchronized LoggerMultiThreading getLogger() {
        if(logger == null) {
            logger = new LoggerMultiThreading();
        }
